import { cocktailService } from './model/components/cocktailService';
...
import { dataServiceRunner } from "./dialogs/dynamic/dataServiceRunner";
...
export default class startup {
    ...
    private _setupSystemServices() {
        ...
        this._container.bind<contracts.IServiceRunner>(contracts.contractSymbols.IServiceRunner)
            .to(dataServiceRunner);
    }
    /**
